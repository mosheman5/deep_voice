function gui_handle = disp_file(file_path, channel, start, length)
...
gui_handle = signal_analyzer(sSignal.sSignal.Signal_vec,sSignal.sSignal.SampleRate, strcat(name,'(', num2str(channel) , ',' , num2str(start), ',' , num2str(length),')'));
